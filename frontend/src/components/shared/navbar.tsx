    ...
    <nav className="sticky top-0 z-50 h-20 bg-vybe-primary border-b-2 border-vybe-black flex items-center justify-between px-6 md:px-12">
      <div className="flex items-center gap-2">
        <div className="w-10 h-10 bg-vybe-black flex items-center justify-center">
          <svg className="w-6 h-6 text-vybe-primary fill-current" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="hidden md:flex items-center gap-8 font-bold">
        <a href="#product" className="hover:underline decoration-2 underline-offset-4">Product</a>
        ...
        <a href="#sre" className="hover:underline decoration-2 underline-offset-4">SRE Dashboard</a>
      </div>
