import { Brain, Route, BarChart3, ShieldCheck, DollarSign } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {innovations.map((inv, i) => (
            <div key={i} className="bg-vybe-light border-2 border-vybe-black p-8 shadow-[8px_8px_0px_0px_#0a1f0c] group hover:-translate-y-2 hover:shadow-[12px_12px_0px_0px_#0a1f0c] transition-all duration-300">
