...
// Lazy load charts
const TrafficChart = lazy(() => import('@/components/analytics/traffic-chart').then(mod => ({ default: mod.TrafficChart })));
const GeoChart = lazy(() => import('@/components/analytics/geo-chart').then(mod => ({ default: mod.GeoChart })));
