# Subset Incident Response Test Suite (Windows PowerShell)
# Tests: 3 (DB Down), 4 (CPU Spike), 5 (Memory Pressure), 6 (Redis Failure)
# Excludes: 1 (Instance Down), 2 (High Error Rate), 7 (Connection Exhaustion)

$ErrorActionPreference = "Stop"

Write-Host "🧪 INCIDENT RESPONSE TEST SUITE - SUBSET" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "Tests: DB Down, CPU Spike, Memory Pressure, Redis Failure" -ForegroundColor Cyan
Write-Host ""
